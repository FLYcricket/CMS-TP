...
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" href="/thinkphp_3.2.3/Public/css/reset.css" />
    <link rel="stylesheet" href="/thinkphp_3.2.3/Public/css/login.css" />
</head>
<body>
<div class="page">
    <div class="loginwarrp">
        ...
        <div class="login_form">
            <form id="login" name="login" method="post" action="<?php echo U ('Login/checklogin');?>">
                ...
                <li class="login-sub">
                    <input type="submit" name="Submit" value="登录" />  <a href="admin_sign.php" class="register">注册</a>
                </li>
            </form>
        </div>
    </div>
