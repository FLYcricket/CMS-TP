...
<div id="dcWrap">
    ...
    <div id="dcMain">
        ...
        <h3><a href="<?php echo U ('Index/add_article_category');?>" class="actionBtn add">添加分类</a>文章分类</h3>
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <?php if(is_array($article_category)): $i = 0; $__LIST__ = $article_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article_category): $mod = ($i % 2 );++$i;?><tr>
                <td align="left"> <a href="article.php?cat_id=1"><?php echo ($article_category["name"]); ?></a></td>
                <td><?php echo ($article_category["extra_name"]); ?></td>
                <td><?php echo ($article_category["info"]); ?></td>
                <td align="center"><a href="http://127.0.0.1/thinkphp_3.2.3/CMS.php/Home/Index/category_editor/id/<?php echo ($article_category["id"]); ?>">编辑</a> |
                    <a href="http://127.0.0.1/thinkphp_3.2.3/CMS.php/Home/Index/category_delete/id/<?php echo ($article_category["id"]); ?>">删除</a></td>
