...
<div id="dcWrap">
    ...
    <div id="dcMain">
        ...
        <form action="<?php echo U ('Index/category_insert');?>" method="post">
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="extra_name" value="" size="40" class="inpMain" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="info" cols="60" rows="4" class="textArea"></textarea>
                    </td>
                </tr>
                <tr>
                    <td></td>
