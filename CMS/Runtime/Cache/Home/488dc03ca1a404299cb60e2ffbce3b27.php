        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                <td width="350" valign="top">
                    <form action="<?php echo U ('Index/show_insert');?>" method="post" enctype="multipart/form-data">
                        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                            ...
                            <tr>
                                <td><b>排序</b>
                                    <input type="text" name="rank" value="50" size="20" class="inpMain" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <td valign="top">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                        ...
                        <?php if(is_array($ppt)): $i = 0; $__LIST__ = $ppt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppt): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center"><a href="<?php echo U ('Index/editor_show');?>?id=<?php echo ($ppt["id"]); ?>">编辑</a> | <a href="<?php echo U ('Index/delete_show');?>?id=<?php echo ($ppt["id"]); ?>">删除</a></td>
