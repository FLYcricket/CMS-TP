        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                <td width="350" valign="top">
                    <form action="<?php echo U ('Index/edit_show');?>" class="formEdit" method="post" enctype="multipart/form-data">
                        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                            <tr>
                                <td><b>幻灯名称</b>
                                    <input type="hidden" name="id" value="<?php echo ($ppt_show["id"]); ?>" size="20" class="inpMain" />
                                    <input type="text" name="name" value="<?php echo ($ppt_show["name"]); ?>" size="20" class="inpMain" />
                                </td>
                            </tr>
                            <tr>
                                <td><b>幻灯图片</b>
                                    <input type="file" name="pic" class="inpFlie" /><img src="/thinkphp_3.2.3<?php echo ($ppt_show["url"]); ?>" style="width: 100px"></td>
                            </tr>
                            <tr>
                                <td><b>链接地址</b>
                                    <input type="text" name="link_url" value="<?php echo ($ppt_show["link_url"]); ?>" size="40" class="inpMain" />
                                </td>
                            </tr>
                            <tr>
                                <td><b>排序</b>
                                    <input type="text" name="rank" value="<?php echo ($ppt_show["rank"]); ?>" size="20" class="inpMain" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="<?php echo U ('Index/show');?>" class="btnGray">取消</a>
                ...
                <td valign="top">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                        ...
                        <?php if(is_array($ppt)): $i = 0; $__LIST__ = $ppt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppt): $mod = ($i % 2 );++$i;?><tr>
                                <td><img src="/thinkphp_3.2.3<?php echo ($ppt["url"]); ?>" width="100" /></td>
                                <td><?php echo ($ppt["name"]); ?></td>
                                <td align="center"><?php echo ($ppt["rank"]); ?></td>
                                <td align="center"><a href="editor_show.html?id=1">编辑</a> | <a href="delshow.htmlid=1">删除</a></td>
