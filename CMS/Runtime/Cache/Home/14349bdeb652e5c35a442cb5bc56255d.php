    ...
    <div class="m_content">
        <div class="in_news">
            ...
            <div class="in_list" id="company">
                ...
                <div class="pic_list">
                    <ul>
                        <?php if(is_array($arr_article)): $i = 0; $__LIST__ = $arr_article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr_article): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('CmsIndex/neirong');?>?id=<?php echo ($arr_article["id"]); ?>" title="<?php echo ($arr_article["title"]); ?>">
